...
const UsersInfo = ({ icon, name, color }) => {
    ...
    return (
        <div className="h-[130px] border-gray-300 border-[1px] rounded-md flex justify-center items-center p-4">
            <div className="flex items-center h-full w-full">
                {/* Left Box */}
                <div className="w-1/2 h-full">
                    <div className="mb-1 text-lg">Session</div>
                ...
                <div className="w-1/2 h-full flex justify-end">
                    <div className={`w-[50px] h-[50px] rounded-md flex items-center justify-center ${bgcolor}`}>
...
const List = () => {
    return (
        <div className="grid sm:grid-cols-4 gap-4 px-4">
